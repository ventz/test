...
<body>
    <div class="chat-container">
        ...
        <div class="input-section">
            ...
            <button class="location-btn" id="locationBtn" onclick="shareLocation()" disabled title="Share location">📍</button>
        ...
        async function shareLocation() {
            ...
            try {
                ...
                const locationMessage = {
                    ...
                    type: 'location',
                    location: { lat, lon, url: mapsUrl }
                };

                await sendMessageToServer(locationMessage);
            } catch (error) {
